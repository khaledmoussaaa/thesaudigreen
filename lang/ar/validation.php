...
return [
    ...
    */
    ...
    // Custom Validations
    'phoneRegex' => 'يرجى إدخال رقم هاتف صحيح',
    'emailRegex' => 'الرجاء إدخال عنوان بريد إلكتروني صحيح',
    'passwordRegex'=> "يجب أن تحتوي كلمة المرور على حرف كبير وحرف صغير ورقم واحد على الأقل.",
    ...
    'date_equals' => 'حقل :attribute يجب أن يكون تاريخًا متساويًا لـ :date.',
    ...
    'declined_if' => 'حقل :attribute يجب أن يكون مرفوضًا عندما يكون :other :value.',
    ...
    'hex_color' => 'حقل :attribute يجب أن يكون لون هكساديسمال صحيحًا.',
    ...
    'missing_if' => 'حقل :attribute يجب أن يكون مفقودًا عندما يكون :other :value.',
    'missing_unless' => 'حقل :attribute يجب أن يكون مفقودًا ما لم يكن :other :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة :attribute قد ظهرت في تسريب بيانات. يرجى اختيار :attribute مختلفًا.',
    ],
    'present' => 'حقل :attribute يجب أن يكون موجودًا.',
    'present_if' => 'حقل :attribute يجب أن يكون موجودًا عندما يكون :other :value.',
    'present_unless' => 'حقل :attribute يجب أن يكون موجودًا ما لم يكن :other :value.',
